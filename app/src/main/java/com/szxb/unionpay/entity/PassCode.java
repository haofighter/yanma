...
public class PassCode {
    ...
    public String getTAG9F41() {
        return "9F410400" + String.format("%06d", BusllPosManage.getPosManager().getTradeSeq());
    }

    @SuppressLint("DefaultLocale")
    public PassCode setTAG9F41(String TAG9F41) {
        this.TAG9F41 = "9F410400" + String.format("%06d", BusllPosManage.getPosManager().getTradeSeq());
        return this;
    }
