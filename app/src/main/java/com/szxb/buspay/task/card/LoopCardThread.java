...
import com.szxb.buspay.task.thread.RecordThread;
...
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_CHECK;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_CHECKED;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_EMP;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_FREE;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_GATHER;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_MEMORY;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_NORMAL;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_OLD;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_SIGNED;
import static com.szxb.buspay.db.entity.bean.card.CardType.CARD_STUDENT;
...
public class LoopCardThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            if (TextUtils.equals(searchCard.cardType, "03")) {
                //爱心卡1分钟内不能连刷
                if (DBManager.filterBrush()) {
            ...
            if (TextUtils.equals(driverNo, String.format("%08d", 0))) {
                ...
                if (TextUtils.equals(searchCard.cardType, "06")) {
                    ...
                    if (TextUtils.equals(response.getStatus(), "00") &&
                        ...
                        RxBus.getInstance().send(new QRScanMessage(null, SIGN));
                    } else {
                ...
                if (TextUtils.equals(searchCard.cardType, "10")) {
                    ...
                    if (TextUtils.equals(response.getStatus(), "00")) {
                        ...
                        if (TextUtils.equals(response.getTransType(), "13")) {
                            ...
                            //员工卡正常消费
                            SLog.d("LoopCardThread(run.java:100)正常消费>>>金额=" + response.getPayFee() + "..余额=" + response.getCardBalance());
                            //检查余额是否大于5元
     ...
     * @return 消费响应
     */
    ConsumeCard response(int pay_fee, boolean isBlack, boolean isWhite, boolean workStatus, boolean isSign) {
        ...
        return new ConsumeCard(sendData, isSign);
    }
    ...
    private void saveRecord(ConsumeCard consumeCard) {
        ThreadScheduledExecutorUtil.getInstance().getService().submit(new RecordThread("zibo", consumeCard));
